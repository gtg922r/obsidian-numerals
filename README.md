...
Inline expressions have full access to **note-global variables** (`$`-prefixed), **frontmatter properties**, and all the same units, currencies, and functions available in math blocks. Trigger prefixes are configurable in settings.
