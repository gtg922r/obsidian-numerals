...
### Added
- Add a disposable Linux CI harness that records official Obsidian Reading callbacks and Live Preview trees for 95 byte-preserved synthetic extraction fixtures, with verified callback origins, support-note hashes, pinned inputs and bounded cancellation.
