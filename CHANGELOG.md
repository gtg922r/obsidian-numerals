...
### Fixed
- Reject stale or incomplete installed-acceptance evidence by replaying pane aliases, retaining the original sample request, matching every journal point read, and invalidating seals after source or plugin changes.
